 ...
 */
namespace GabrielGama\GiftRule\Block\Adminhtml\Promo\Quote;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'GabrielGama_GiftRule';
    ...
    {
        $rule = $this->_coreRegistry->registry('current_promo_quote_gift_rule');
        if ($rule->getRuleId()) {
